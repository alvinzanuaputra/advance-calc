...
use App\Services\Calculators\ScientificCalculatorService;
use Illuminate\Http\Request;

class ScientificCalculatorController extends Controller
{
    public function __construct(private ScientificCalculatorService $service)
    {
    }
    ...
    public function handle(Request $request)
    {
        ...
        return view('calculator.scientific', [
            'mode' => 'scientific',
            'display' => $display,
            'result' => $result,
